      ...
      if (uuidRegex.test(splittedByTabs[0])) {
        ...
        if (splittedByTabs.length > 0) {
          if (splittedByTabs[0].endsWith('}')) {
            ...
            if (splittedByTabs[0].startsWith('Invoke Error\n')) {
              toLog.message = 'Invoke Error'
              splittedByTabs[0] = splittedByTabs[0].substring(13)
            }
            if (splittedByTabs[0].startsWith('Invoke Error \n')) {
              toLog.message = 'Invoke Error'
              splittedByTabs[0] = splittedByTabs[0].substring(14)
            }
          }
